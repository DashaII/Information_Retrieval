...
2.	For some reason relative path to index folder for PyTerrier library didn't work for me, so I indicated the full path in configs.py file under **_INDEX_PATH_RUN* name.
